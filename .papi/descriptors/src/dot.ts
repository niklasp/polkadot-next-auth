import {StorageDescriptor, PlainDescriptor, TxDescriptor, RuntimeDescriptor, Enum, _Enum, GetEnum, QueryFromPalletsDef, TxFromPalletsDef, EventsFromPalletsDef, ErrorsFromPalletsDef, ConstFromPalletsDef, SS58String, FixedSizeBinary, Binary, FixedSizeArray} from "polkadot-api";
  ...
  const descriptorValues = import("./descriptors").then(module => module["Dot"]);
 ...
 */
Events: StorageDescriptor<[], Anonymize<Ifc1lrgdnfp93l>, false, never>,
 ...
 */
schedule: TxDescriptor<Anonymize<I6qrul5ppjg04o>>,
 ...
 */
schedule_named: TxDescriptor<Anonymize<I39hrm1ul9d7j3>>,
 ...
 */
schedule_after: TxDescriptor<Anonymize<I3dqq1kl4ta3h1>>,


/**
 *Schedule a named task after a delay.
 */
schedule_named_after: TxDescriptor<Anonymize<Iedm48sjgjthn1>>,
 ...
 */
dispatch_whitelisted_call_with_preimage: TxDescriptor<Anonymize<Iakiss84dgak4n>>},
Claims: {
 ...
 *event is deposited.
 */
batch: TxDescriptor<Anonymize<I9p0um8kpbr12g>>,
 ...
 *The dispatch origin for this call must be _Signed_.
 */
as_derivative: TxDescriptor<Anonymize<I7uhrd29q39ufc>>,
 ...
 *- O(C) where C is the number of calls to be batched.
 */
batch_all: TxDescriptor<Anonymize<I9p0um8kpbr12g>>,
 ...
 *- O(1).
 */
dispatch_as: TxDescriptor<Anonymize<I67mcnf0a999m8>>,
 ...
 *- O(C) where C is the number of calls to be batched.
 */
force_batch: TxDescriptor<Anonymize<I9p0um8kpbr12g>>,
 ...
 *The dispatch origin for this call must be _Root_.
 */
with_weight: TxDescriptor<Anonymize<Iaglml4f420m9p>>},
Proxy: {
 ...
 */
proxy: TxDescriptor<Anonymize<Ift6640jkhjjp7>>,
 ...
 *- `call`: The call to be made by the `real` account.
 */
proxy_announced: TxDescriptor<Anonymize<Ibi0iatpvqjc0n>>},
Multisig: {
 ...
 */
as_multi_threshold_1: TxDescriptor<Anonymize<I2u5nmvda3ksut>>,
 ...
 */
as_multi: TxDescriptor<Anonymize<I5062qdvfub72u>>,
 ...
 *An extrinsic failed.
 */
ExtrinsicFailed: PlainDescriptor<Anonymize<Ie1apphr8o5a96>>,
 ...
 */
Dispatched: PlainDescriptor<Anonymize<Ido4754sslradr>>,
 ...
 */
WhitelistedCallDispatched: PlainDescriptor<Anonymize<I4u5vbi92efqr2>>},
Claims: {
 ...
 *well as the error.
 */
BatchInterrupted: PlainDescriptor<Anonymize<Ibingl7cng5dvj>>,
 ...
 */
ItemFailed: PlainDescriptor<Anonymize<I8c8d3j0mf0r8k>>,


/**
 *A call was dispatched.
 */
DispatchedAs: PlainDescriptor<Anonymize<Iepesff449kkdr>>},
Proxy: {

/**
 *A proxy was executed correctly, with the given.
 */
ProxyExecuted: PlainDescriptor<Anonymize<Iepesff449kkdr>>,
 ...
 */
MultisigExecuted: PlainDescriptor<Anonymize<Iep2qi870lrp7o>>,
 ...
 */
Unstaked: PlainDescriptor<Anonymize<Id34eq8cv04htb>>,
 ...
 */
HandleBidResult: PlainDescriptor<Anonymize<I7o17b2v4n3s9a>>,
 ...
 * this block or not.
 */
apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I5l34omdfueora>>,
 ...
 */
query_call_info: RuntimeDescriptor<[call: Anonymize<I9slagtkgsv9j0>, len: number], Anonymize<I6spmpef2c7svf>>,


/**
 * Query fee details of a given encoded `Call`.
 */
query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I9slagtkgsv9j0>, len: number], Anonymize<Iei2mvq0mjvt81>>,
 ...
 * Dry run call.
 */
dry_run_call: RuntimeDescriptor<[origin: PolkadotRuntimeOriginCaller, call: Anonymize<I9slagtkgsv9j0>], Anonymize<If1fmg4i09v1d8>>,


/**
 * Dry run XCM program
 */
dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<I76k77qd5gtluu>>},
...
export type DotDispatchError = Anonymize<Iasuqahos5nsl>
const asset: IAsset = {} as IAsset
const getMetadata: () => Promise<Uint8Array> = () => import("./dot_metadata").then(
  module => toBinary('default' in module ? module.default : module)
)
const genesis: string | undefined = "0x91b171bb158e2d3848fa23a9f1c25182fb8e20313b2c1eb49219da7a70ce90c3"
...
export type DotCallData = Anonymize<I9slagtkgsv9j0> & { value: { type: string } };
